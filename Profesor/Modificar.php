...
<br/>
    ...
    <tr>
      <td width="147"><h2 class="logo" style="color:#FFF">MODIFICAR</h2></td>
    </tr>
  </table>
	</center>
    <br/>
...
<br/>
        ...
        <form name="formulario" action="" method="POST">
            <table border="15" bordercolor="#4c8f96" >
                ...
                <tr>
                    <td>Nota</td>
                    <td><input type="number" name="nota" id="nota" value="<?php echo $row['nota']?>" min="0" max="20" maxlength="2" /></td>
                </tr>
...
<?php
        ...
        if(isset ($_POST['enviar'])){
         ...
         $Sql = "UPDATE usuario SET nota='$nota' where idUsuario='$id'"; 
    ...
    <tr>
      <td width='314'><h2 style='color:#FFF'>Modificado Correctamente <br/> Actualizando Nota<br>
